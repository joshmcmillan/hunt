...
describe HuntsController do
  ...
  describe "GET new" do
    it "assigns a new hunt as @hunt" do
      ...
      assigns(:hunt).should be_a_new(Hunt)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created hunt as @hunt" do
        post :create, {:hunt => valid_attributes}, valid_session
        assigns(:hunt).should be_a(Hunt)
        assigns(:hunt).should be_persisted
      end

      it "redirects to the created hunt" do
        post :create, {:hunt => valid_attributes}, valid_session
        response.should redirect_to(Hunt.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved hunt as @hunt" do
        ...
        Hunt.any_instance.stub(:save).and_return(false)
        post :create, {:hunt => {  }}, valid_session
        assigns(:hunt).should be_a_new(Hunt)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested hunt" do
        hunt = Hunt.create! valid_attributes
        # Assuming there are no other hunts in the database, this
        # specifies that the Hunt created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Hunt.any_instance.should_receive(:update).with({ "these" => "params" })
        put :update, {:id => hunt.to_param, :hunt => { "these" => "params" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the hunt as @hunt" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Hunt.any_instance.stub(:save).and_return(false)
        put :update, {:id => hunt.to_param, :hunt => {  }}, valid_session
        assigns(:hunt).should eq(hunt)
      end
